...
export default class RtcEngine implements RtcEngineInterface {
     ...
     * @since v3.7.0
     */
    setRemoteUserSpatialAudioParams(uid: number, params: SpatialAudioParams): Promise<void>;
    /**
     ...
     * @param parameters The configuration of the screen sharing. See [`ScreenCaptureParameters`]{@link ScreenCaptureParameters}.
     */
    updateScreenCaptureParameters(parameters: ScreenCaptureParameters): Promise<void>;
}
/**
 * @ignore
 */
